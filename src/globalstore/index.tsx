 ...
 * ```
 */
import { OrganizationModel,useOrganizationPresenter } from '@/models';
import React from 'react';

import { createContext } from '@/utils';
// import { OrganizationModel, useOrganizationPresenter } from '';
...
function GlobalStore(props: GlobalStorePropTypes) {
  const organization = useOrganizationPresenter();
  const values = React.useMemo<GlobalStoreContextType>(() => ({ organization }), [organization]);
